        ...
        <div>
            <footer className="bg-gray-50 ">
                <div className="container p-6 mx-auto">
                        ...
                        <div className="w-full -mx-6 lg:w-2/5">
                            <div className="px-6">
                                <div>
                                    ...
                                    <a href="#" className="text-2xl font-bold  hover:text-gray-700 dark:hover:text-gray-300">Career Network</a>
                    ...
                    <div>
                        <p className="text-center ">© Career Network 2020 - All rights reserved</p>
                    </div>
                </div>
            </footer>
        </div>
