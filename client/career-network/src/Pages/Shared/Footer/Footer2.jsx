                            ...
                            <div class="">
                                <form>
                                    <div class="flex   overflow-hidden rounded  dark:border-gray-600 lg:flex-row dark:focus-within:border-blue-300 focus-within:ring focus-within:ring-opacity-40 focus-within:border-blue-400 focus-within:ring-blue-300">
                                        <input class="px-6 w-48   text-gray-700 placeholder-gray-500 rounded rounded-r-none bg-white outline-none dark:bg-gray-800 dark:placeholder-gray-400 focus:placeholder-transparent dark:focus:placeholder-transparent" type="text" name="email" placeholder="Email" aria-label="Enter your email" />

                                        <button class="px-4 py-3 text-sm font-medium tracking-wider rounded-l-none text-gray-100 uppercase transition-colors duration-300    transform bg-[#26AE61] rounded-md hover:bg-gray-600 focus:bg-gray-600 focus:outline-none">subscribe</button>
                                    </div>
                                </form>
                            </div>
