...
const Navbar = () => {
    ...
    return (
        <div className='relative'>
            ...
            <div className=''>
                <div className={`w-full lg:hidden z-10 fixed bg-sky-700 backdrop-blur-3xl duration-1000 ${menu?'h-0 duration-1000 hidden':"h-full duration-1000 block bg-sky-700" }`}>
                    <ul className=''>
                    {navItem.map((item,index) =>(
