...
const Navbar = () => {
    ...
    const navItems =<>
        ...
        <>
        {
            user?.uid && <li className={`px-4 lg:pl-0 pl-10 mx-1 lg:py-1 py-2 lg:text-black ${menu? "text-black": "text-white"} font-besicFont hover:bg-sky-900 lg:hover:bg-transparent`}><Link to={"/deshbord"}>Dashboard</Link></li>
        }
        </>
        {user?.uid ? <>
